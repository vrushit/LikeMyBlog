    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String commet_message = comment_field.getText().toString();
                if(!commet_message.isEmpty())
                {

                    Map<String, Object> commentsMap = new HashMap<>();

                    commentsMap.put("message",commet_message);
                    ...
                    firebaseFirestore.collection("Posts/" + blog_post_id + "/comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            ...
                            {
                                Toast.makeText(CommentActivity.this, "Error Posting Error :" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
